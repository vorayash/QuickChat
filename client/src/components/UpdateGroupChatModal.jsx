...
const UpdateGroupChatModal = ({
  ...
  const handleRemoveUser = async (userToBeRemoved) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `${process.env.REACT_APP_BACKEND_URL}/api/chats/groupremove`,
        {
  ...
  const handleRename = async () => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `${process.env.REACT_APP_BACKEND_URL}/api/chats/grouprename`,
  ...
  const handleAddMember = async (userToAdd) => {
    if (userToAdd.email === "guest@quickChat.com") {
    ...
    try {
      ...
      const { data } = await axios.put(
        `${process.env.REACT_APP_BACKEND_URL}/api/chats/groupadd`,
        {
